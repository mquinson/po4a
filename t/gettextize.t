...
push @tests, {
    'run' =>
      "cd tmp ; ../PATH/po4a-gettextize -f text -o markdown -m ../gettextize/test_ok.md -l ../gettextize/TEST_OK.md -p ./generated.po 2> tmp/err",
    ...
    #  },
    #  {
    #    'run'   => "PATH/po4a-gettextize -f text -o markdown -m gettextize/test_dups.md -l gettextize/TEST_OK.md -p tmp/generated.po 2> tmp/err",
    #    'tests' => ["diff $PODIFF -u tmp/generated.po gettextize/test_dups.po", "diff -u gettextize/test_dups.err tmp/err"],
