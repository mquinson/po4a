...
push @tests, {
  'run'  => "LC_ALL=C COLUMNS=80 perl ../po4a-gettextize -f latex -m t-19-tex/simple.tex -p tmp/simple.pot > tmp/simple-gettextize.out 2>&1",
  ...
  'test' => "diff -u -I '^\.* done\.' t-19-tex/simple-updatepo.out tmp/simple-updatepo.out".
        " && perl compare-po.pl t-19-tex/simple.fr.po tmp/simple.fr.po",
  'doc'  => "updatepo for this document",
}, {
  'run'  => "LC_ALL=C COLUMNS=80 perl ../po4a-translate -f latex -m t-19-tex/simple.tex -p t-19-tex/simple.fr.po -l tmp/simple.fr.tex > tmp/simple-translate.out 2>&1",
  'test' => "diff -u t-19-tex/simple-translate.out tmp/simple-translate.out".
        " && diff -u $diff_tex_flags t-19-tex/simple.fr.tex tmp/simple.fr.tex",
  'doc'  => "translate this document",
}, {
  'run'  => "LC_ALL=C COLUMNS=80 perl ../po4a-gettextize -f latex -m t-19-tex/theorem.tex -p tmp/theorem.pot > tmp/theorem-gettextize.out 2>&1",
