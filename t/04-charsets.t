...
push @tests,
  {
    ...
    'tests'=> ['perl compare-po.pl t-04-charsets/ascii.po-ok tmp/ascii.po'],
  ...
  },
  {
    ...
    'tests'=> ['diff -u -I^\"POT-Creation-Date: -I^\"PO-Revision-Date: t-04-charsets/iso8859.po-ok tmp/iso8859.po'],
  ...
  },
  {
    ...
    'tests'=> ['diff -u -I^\"POT-Creation-Date: -I^\"PO-Revision-Date:  t-04-charsets/ascii-iso8859.po-ok tmp/ascii-iso8859.po'],
  ...
  },
  {
    ...
    'tests'=> ['diff -u -I^\"POT-Creation-Date: -I^\"PO-Revision-Date: t-04-charsets/text-iso8859.pod-ok tmp/text-iso8859.pod'],
  ...
  },
  {
    ...
    'tests'=> ['diff -u -I^\"POT-Creation-Date: -I^\"PO-Revision-Date: t-04-charsets/utf.po-ok tmp/utf.po'],
  ...
  },
  {
    ...
    'tests' => ['diff -u -I^\"POT-Creation-Date: -I^\"PO-Revision-Date: t-04-charsets/utf.pod-ok tmp/utf.pod'],
