...
push @tests,
  ...
  {
    'run'   => "PATH/po4a-translate -f man -m t-11-man/quotes -p t-11-man/quotes.fr.po -l tmp/quotes.fr",
    'tests' => ["diff -u $diff_pod_flags t-11-man/quotes.fr tmp/quotes.fr"],
    'doc'   => "translate this document",
  },
  {
    'run' =>
      "PATH/po4a-translate -f man -m t-11-man/quoted-comment -p t-11-man/quoted-comment.po -l tmp/quoted-comment.fr",
  ...
  # Dots (9 tests)
  {
    'run'   => "PATH/po4a-gettextize -f man -m t-11-man/dot1 -p tmp/dot1.pot 2>/dev/null",
  ...
  {
    'run' =>
      "PATH/po4a-translate -f man -m t-11-man/mdoc.1 -p t-11-man/mdoc.fr.po -l tmp/mdoc.fr -L ISO-8859-1 2>/dev/null",
