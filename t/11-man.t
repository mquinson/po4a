...
push @tests,
  {
    'run' =>
"PATH/po4a-gettextize -f man -m t-11-man/quotes -p tmp/quotes.pot 2>/dev/null",
...
"PATH/po4a-gettextize -f man -m t-11-man/dot1 -p tmp/dot1.pot 2>/dev/null",
  ...
  {
    'run' =>
"PATH/po4a-translate -f man -m t-11-man/dot1 -p t-11-man/dot1.fr.po -l tmp/dot1.fr",
    'test' => "diff -u $diff_pod_flags t-11-man/dot1.fr tmp/dot1.fr 1>&2",
    'doc'  => "translate this document",
  },
  {
    'run' =>
"PATH/po4a-gettextize -f man -m t-11-man/dot2 -p tmp/dot2.pot 2>tmp/dot2.err || true",
  ...
  {
    'run' =>
"PATH/po4a-gettextize -f man -m t-11-man/dot3 -p tmp/dot3.pot 2>tmp/dot3.err || true",
  ...
  {
    'run' =>
"PATH/po4a-gettextize -f man -m t-11-man/dot4 -p tmp/dot4.pot 2>tmp/dot4.err || true",
  ...
  {
    'run' =>
"PATH/po4a-gettextize -f man -m t-11-man/dot5 -p tmp/dot5.pot 2>/dev/null",
  ...
  {
    'run' =>
"PATH/po4a-translate -f man -m t-11-man/dot5 -p t-11-man/dot5.it.po -l tmp/dot5.it",
  ...
  {
    'run' =>
"PATH/po4a-gettextize -f man -m t-11-man/null -p tmp/null.pot 2>/dev/null",
  ...
  {
    'run' =>
"PATH/po4a-translate -f man -m t-11-man/null -p t-11-man/null.fr.po -l tmp/null.fr",
  ...
  {
    'run' =>
"PATH/po4a-gettextize -f man -m t-11-man/escapes1 -p tmp/escapes1.pot 2>/dev/null",
  ...
  {
    'run' =>
"PATH/po4a-translate -f man -m t-11-man/escapes1 -p t-11-man/escapes1.it.po -l tmp/escapes1.it",
    'test' =>
  ...
  {
    'run' =>
      "PATH/po4a-gettextize -f man -m t-11-man/fonts -p tmp/fonts.pot",
    'test' => "perl compare-po.pl t-11-man/fonts.pot tmp/fonts.pot",
    'doc'  => "gettextize well fonts",
  },
  {
    'run' =>
"PATH/po4a-translate -f man -m t-11-man/fonts -p t-11-man/fonts.en.po -l tmp/fonts.en 2>/dev/null",
  ...
  {
    'run' =>
"PATH/po4a-gettextize -f man -m t-11-man/mdoc.1 -p tmp/mdoc.pot 2>/dev/null",
...
"PATH/po4a-translate -f man -m t-11-man/mdoc.1 -p t-11-man/mdoc.fr.po -l tmp/mdoc.fr -L ISO-8859-1 2>/dev/null",
  ...
  {
    'run' =>
"PATH/po4a-gettextize -f man -m t-11-man/tbl-textblock.1 -p tmp/tbl-textblock.pot 2>/dev/null",
    'test' =>
  ...
  {
    'run' =>
"PATH/po4a-gettextize -f man -m t-11-man/tbl-option-tab.1 -p tmp/tbl-option-tab.pot 2>/dev/null",
    'test' =>
...
"diff -u $diff_pod_flags t-11-man/tbl-option-tab.fr.1 tmp/tbl-option-tab.fr.1 1>&2",
  ...
  {
    'run' =>
"cp t-11-man/mixed.fr.po tmp/ && chmod u+w tmp/mixed.fr.po && PATH/po4a t-11-man/mixed.cfg",
  ...
  {
    'run' =>
"PATH/po4a-gettextize -f man -m t-11-man/spaces -p tmp/spaces.pot 2>/dev/null",
...
"diff -u $diff_pod_flags t-11-man/spaces.fr_latin1 tmp/spaces.fr_latin1 1>&2",
  ...
  {
    'run' =>
"PATH/po4a-translate -f man -m t-11-man/spaces -p t-11-man/spaces.fr_utf8.po -l tmp/spaces.fr_utf8",
    'test' =>
  ...
  {
    'run' =>
"PATH/po4a-translate -f man -m t-11-man/spaces -p t-11-man/spaces.ja.po -l tmp/spaces.ja",
  ...
  {
    'run' =>
"PATH/po4a-gettextize -f man -m t-11-man/hyphens.1 -p tmp/hyphens.pot -o groff_code=verbatim 2>/dev/null",
    'test' =>
...
"diff -u $diff_pod_flags t-11-man/hyphens.verbatim.fr tmp/hyphens.fr 1>&2",
  ...
  {
    'run' =>
"PATH/po4a-gettextize -f man -m t-11-man/hyphens.1 -p tmp/hyphens.pot -o groff_code=translate 2>/dev/null",
    'test' =>
...
"diff -u $diff_pod_flags t-11-man/hyphens.translate.fr tmp/hyphens.fr 1>&2",
  ...
  {
    'run' =>
"PATH/po4a-gettextize -f man -m t-11-man/macros.1 -p tmp/macros.pot 2>/dev/null",
    'test' => "perl compare-po.pl --no-ref t-11-man/macros.pot tmp/macros.pot",
    'doc'  => "check for correct handling of some macros",
  },
  {
    'run' =>
"PATH/po4a-translate -f man -m t-11-man/macros.1 -p t-11-man/macros.de.po -l tmp/macros.de.1 2>/dev/null",
    'test' =>
      "diff -u $diff_pod_flags t-11-man/macros.de.1 tmp/macros.de.1 1>&2",
    'doc' => "translate this document",
  };
