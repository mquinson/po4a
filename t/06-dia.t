...
push @tests,
  {
    ...
    'run' =>
"PATH/po4a-gettextize -f dia -m t-06-dia/extract.dia -p tmp/dia_extract.po",
    'test' => "perl compare-po.pl t-06-dia/extract.po-ok tmp/dia_extract.po",
  },
  {
    'doc' => "test translations with new-lines",
    'run' =>
"PATH/po4a-translate -f dia -m t-06-dia/transl.dia -p t-06-dia/transl.po -l tmp/transl.dia",
