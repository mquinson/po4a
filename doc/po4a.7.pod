...
=item CommonMark (newly introduced in 2026)

L<CommonMark|https://commonmark.org/> is the standard, unambiguous
syntax specification for Markdown.  This is similar to the C<Text>
module with the option C<markdown>.  Since it is newly created, some
bugs are expected.  If you notice any strange behavior or want some
...
L<msgmerge(1)> and L<msgfmt(1)> respectively.
...
L<YunoHost|https://yunohost.org/> (markdown): a system that installs
itself on a server and allows you to install and maintain - with very
little technical knowledge - digital services (apps) that you control.
...
that while B<po4a> can be used as a replacement to these scripts once you provide a config file, there is quite a lot of
...
The parser of each format, in particular to see the options they accept:
L<Locale::Po4a::AsciiDoc(3pm)>, 
...
L<Locale::Po4a::Text(3pm)>, L<Locale::Po4a::CommonMark(3pm)>,
L<Locale::Po4a::Xhtml(3pm)>, L<Locale::Po4a::Yaml(3pm)>,
L<Locale::Po4a::BibTeX(3pm)>, L<Locale::Po4a::Docbook(3pm)>,
L<Locale::Po4a::Halibut(3pm)>, L<Locale::Po4a::LaTeX(3pm)>,
L<Locale::Po4a::Org(3pm)>, L<Locale::Po4a::Pod(3pm)>,
L<Locale::Po4a::SimplePod(3pm)>, L<Locale::Po4a::Sgml(3pm)>,
L<Locale::Po4a::TeX(3pm)>, L<Locale::Po4a::VimHelp>,
