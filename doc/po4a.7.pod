...
L<po4a-gettextize(1)> as follows to bootstrap the POT file when converting your
project to po4a (prefer L<po4a-updatepo(1)> once everything is set up, and reserve
L<po4a-gettextize(1)> to this initial conversion). The obtained POT file can then
be copied into F<XX.po> to initiate a new translation.
