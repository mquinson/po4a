...
This sections probably gives too much details for a first read. Make sure to read L<po4a(1)> first,
as it gives a simplified overview of the po4a workflow. Come back here when you want to get the full
scary picture, with almost all details.
...
the gettext() method, write the PO into a file. More advanced features such as
...
Indeed, B<po4a-updatepo> and B<po4a-translate> are deprecated in flavor of B<po4a>. The reason is
