...
determine the end of this section. The boundary argument is a regexp
matching then end of the section, and the beginning of the next one.
...
document. So, to get the context, just read (and translate) all strings in
the given order.
...
LocalWords:  gtranslator gettextization cvs regexp beginboundary endboundary
