...
not directly after that point. It is placed after the section which begins
at the I<insertion point>. So, the C<beginboundary> and C<endboundary>
arguments are used to specify the regexp matching the end of section.
